...
| v2.19.94 | Loja de API Fase 2: GET/POST anexos de requisição |
| v2.19.95 | Loja de API Fase 2: POST convite de fornecedor na cotação |
| v2.19.96 | Loja de API Fase 2: GET reports saving/spend + scroll sidebar /docs/api |
| v2.19.97 | Loja de API: modelo JSON de pedido ERP-ready (GET + outbound) |
...
| v2.19.82 | Enforcement permissões: order.view_all, order.edit_own, quotation.edit, equalize.select |
...
- feature gate: ai_analytics (dashboard), ai_negotiation (equalização), ai_negotiation_autonomous (motor autônomo — premium)
